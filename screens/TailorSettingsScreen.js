...
export default function TailorSettingsScreen({ route, navigation }) {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <TextInput style={styles.input} value={phone} onChangeText={setPhone}
        placeholder="Your phone" placeholderTextColor="#aaa" keyboardType="phone-pad" />

      <Text style={styles.label}>Email</Text>
      <View style={styles.inputDisabled}>
        <Text style={styles.inputDisabledText}>{user.email || 'Not available'}</Text>
      </View>
      ...
      <View style={styles.statusBox}>
        <Text style={styles.statusText}>
          {user.is_approved ? '✅ Approved — you can post' : '⏳ Pending admin approval'}
        </Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  statusBox: { backgroundColor: '#2a2a3e', padding: 14, borderRadius: 10, marginHorizontal: 20 },
